!(function (e) {
                    ...
                    new Chart(e, {
                        ...
                        data: {
                            ...
                            datasets: [
                                {
                                    data: [
                                        4e3, 4500, 4900, 5500, 4500, 4100, 4e3,
                                        5e3
                                    ],
                                    borderColor: '#0049fa',
                                    backgroundColor: t,
                ...
                new Chart(e, {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                data: [
                                    10, 35, 4, 20, 44, 22, 52, 12, 23, 45, 56,
                                    76, 43, 9, 32, 54, 60, 33, 54, 80
                                ],
                                borderColor: '#0049fa',
                                fill: !1,
                                borderWidth: 2,
    ...
    230: function (e, t) {
        !(function () {
            ...
            function n () {
                ;(
                    document.querySelectorAll('.aside .collapse.show') || []
                ).forEach(e => {
                    const t = e
                        .closest('.menu-item')
    ...
    280: function (e, t, o) {
        ...
        a.a.use([r.a, i.a, d.a, l.a, c.a, u.a, p.a, f.a, m.a, b.a, j.a]),
            document.addEventListener('DOMContentLoaded', () => {
                ;(document.querySelectorAll('[data-swiper]') || []).forEach(
                    e => {
                        let t =

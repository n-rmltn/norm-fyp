<x-main-layout>
    ...
    <div class="d-flex flex-column w-100 align-items-center">
      ...
      <!-- Logo-->
        <a href="{{ route('dashboard') }}" class="d-table mt-5 mb-4 mx-auto">
      ...
      <!-- Logo-->
        ...
        @csrf
            ...
            <div class="form-group">
                <x-input-label for="password" class="form-label d-flex justify-content-between align-items-center" :value="__('Password')"/>
